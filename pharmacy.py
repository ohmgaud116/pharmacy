...
class PharmacymanagementSystem():
    def __init__(self, root):
        ...
        cursor.execute("select ref from new_pharmacy")
        row=cursor.fetchall()
        ...
        type_combo["values"] = ("syrup","tab","injection")
        ...
        cursor = self.connection.cursor()
        cursor.execute("select medname from new_pharmacy")
        row=cursor.fetchall()
        medname_combo["values"] = row
...
#============================================================================================================================================
        # buttons frame
        self.buttonframe = Frame(self.root,bd=15,relief=FLAT)
        self.buttonframe.place(x=40,y=400 , width=1530, height=55)
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    def create_frames(self):
        ...
        # Billing Frame
        self.billing_frame = Frame(self.root, bg="white")
        ...
        btn8=Button(self.buttonframe,text="Billing",fg="black",font=("times new roman", 15),bg="green",padx=25,bd=5,command=self.show_billing)
        btn8.grid(row=0,column=10)

    def setup_billing_frame(self):
        # Add setup code for the billing frame here
        # Example: Create labels, entries, etc. for the billing frame
        

        billing_label = Label(self.billing_frame, text="Billing Page", font=("times new roman", 24, "bold"), bg="yellow")
        billing_label.pack(pady=20)

        refbilling=Label(self.billing_frame,text="reference number",font=("times new roman",14,"bold"))
        refbilling.pack(padx=0,pady=10)

        refbilling_combo= Entry(self.billing_frame,font=("times new roman",14))
        refbilling_combo.pack(padx=10,pady=10)
        
        # Add more widgets and layout settings
        self.billing_frame.pack_forget()
...
#=======================================================================================================================================================================================
    ...
    def fetch_data(self):
        cursor=self.connection.cursor()
        cursor.execute("select*from new_pharmacy")
...
#================================medicineget cursoe================================
    ...
    # Set the variables to the values from the selected row
        self.addref_var.set(rows[0])
        self.addmed_var.set(rows[1])
